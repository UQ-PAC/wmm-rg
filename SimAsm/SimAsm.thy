...
fun beh\<^sub>a :: "('v::truth,'g,'r,'a) auxop \<Rightarrow> ('v,'g,'r,'a) state rel"
...
fun fwd\<^sub>s :: "('v::truth,'g,'r,'a) opbasic \<Rightarrow> ('v,'g,'r,'a) auxop \<Rightarrow> ('v,'g,'r,'a) opbasic" 
  where 
...
definition liftg :: "('v::truth,'g,'r,'a) pred \<Rightarrow> ('v,'g,'r) op \<Rightarrow> ('v,'g,'r,'a) auxfn \<Rightarrow> ('v,'g,'r,'a) opbasic" 
...
definition liftl :: "('v::truth,'g,'r) op \<Rightarrow> ('v,'g,'r,'a) opbasic" 
  ("\<lfloor>_\<rfloor>" 100)
...
datatype ('v,'g,'r,'a) lang =
  ...
  | If "('v,'g,'r) exp" "('v,'g,'r,'a) lang" "('v,'g,'r,'a) lang"
  | While "('v,'g,'r) exp" "('v,'g,'r,'a) pred" "('v,'g,'r,'a) lang"
  | DoWhile "('v,'g,'r,'a) pred" "('v,'g,'r,'a) lang" "('v,'g,'r) exp"
